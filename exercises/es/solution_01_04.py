...
# Procesa el texto
doc = nlp(
    "En 1990, más del 60% de las personas en Asia del Este se encontraban en extrema pobreza. "
    "Ahora, menos del 4% lo están."
)
...
for token in doc:
    ...
    if token.like_num:
        ...
        if next_token.text == "%":
            print("Porcentaje encontrando:", token.text)
