def test():
    ...
    assert ents[0][1] == (21, 28, "WEBSITE"), "Revisa la entidad dos en el primer ejemplo"
    assert len(ents[1]) == 1, "Esperaba una entidad en el segundo ejemplo"
    assert ents[1][0] == (18, 25, "WEBSITE"), "Revisa la entidad en el segundo ejemplo"
    assert len(ents[2]) == 1, "Esperaba una entidad en el tercer ejemplo"
    assert ents[2][0] == (0, 6, "WEBSITE"), "Revisa la entidad en el tercer ejemplo"
