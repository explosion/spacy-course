def test():
    ...
    assert span1.text == "great restaurant", "As-tu généré correctement span1 ?"
    assert span2.text == "really nice bar", "As-tu généré correctement span2 ?"
    assert (
    ...
    __msg__.good(
        ...
        "applications de TALN qui exploitent la similarité sémantique, tu "
