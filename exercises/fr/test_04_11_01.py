def test():
    ...
    assert ents[0][1] == (21, 28, "WEBSITE"), "Vérifie l'entité deux dans le premier exemple"
    assert len(ents[1]) == 1, "Attendu une entité dans dans le deuxième exemple"
    assert ents[1][0] == (18, 25, "WEBSITE"), "Vérifie l'entité dans le deuxième exemple"
    assert len(ents[2]) == 1, "Attendu une entité dans dans le troisième exemple"
    assert ents[2][0] == (0, 6, "WEBSITE"), "Vérifie l'entité dans le troisième exemple"
