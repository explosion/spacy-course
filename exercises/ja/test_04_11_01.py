def test():
    ...
    assert ents[0][0] == (24, 30, "WEBSITE"), "最初のデータの1番目の固有表現を確認してください。"
    assert ents[0][1] == (31, 38, "WEBSITE"), "最初のデータの2番目の固有表現を確認してください。"
    assert len(ents[1]) == 1, "2番目のデータには1つの固有表現が含まれています。"
    assert ents[1][0] == (8, 15, "WEBSITE"), "2番目のデータの固有表現を確認してください。"
