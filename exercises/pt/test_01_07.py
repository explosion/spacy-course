def test():
    ...
    assert nlp.meta["lang"] == "en", "Você está carregando o fluxo de processamento correto?"
    assert nlp.meta["name"] == "core_web_sm", "Você está carregando o fluxo de processamento correto?"
